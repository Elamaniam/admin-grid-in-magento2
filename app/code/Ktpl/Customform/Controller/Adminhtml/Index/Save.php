...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            try {
                $model->save();
                $this->messageManager->addSuccess(__('The entry has been saved.'));
                $this->_objectManager->get('Magento\Backend\Model\Session')->setFormData(false);
                if ($this->getRequest()->getParam('back')) {
                    return $resultRedirect->setPath('*/*/edit', ['ktpl_emp_id' => $model->getId(), '_current' => true]);
                }
            ...
            return $resultRedirect->setPath('*/*/edit', ['ktpl_emp_id' => $this->getRequest()->getParam('ktpl_emp_id')]);
        }
        return $resultRedirect->setPath('*/*/');
    }
}
